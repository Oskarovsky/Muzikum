...
@Component({
  selector: 'app-tracks-techno',
  templateUrl: './tracks-techno.component.html',
  styleUrls: ['./tracks-techno.component.scss']
})
export class TracksTechnoComponent implements OnInit {
