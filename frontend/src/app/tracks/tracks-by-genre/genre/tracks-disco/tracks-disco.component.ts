...
@Component({
  selector: 'app-tracks-disco',
  templateUrl: './tracks-disco.component.html',
  styleUrls: ['./tracks-disco.component.scss']
})
export class TracksDiscoComponent implements OnInit {
