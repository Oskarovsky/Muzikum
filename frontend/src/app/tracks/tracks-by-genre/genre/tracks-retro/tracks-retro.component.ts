...
@Component({
  selector: 'app-tracks-retro',
  templateUrl: './tracks-retro.component.html',
  styleUrls: ['./tracks-retro.component.scss']
})
export class TracksRetroComponent implements OnInit {
