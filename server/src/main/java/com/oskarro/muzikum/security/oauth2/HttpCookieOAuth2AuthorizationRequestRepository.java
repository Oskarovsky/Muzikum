 ...
 *
 * The application compares the value of the state parameter returned from the OAuth2 provider
 * with the value that it had sent initially. If they don’t match then it denies the authentication request.
 *
